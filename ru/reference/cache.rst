...
--------------------------
Эта возможность компонента кеширования позволяет разработчику осуществлять кеш в несколько уровней. Возможность
будет полезна при сохранении кеша в нескольких местах (системах кеширования) с разным временем жизни, и последующим
...
.. code-block:: php
    ...
    // Сохраняем, сохраняется сразу во все адаптеры кеширования
